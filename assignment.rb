...
#std0 = Student.new(kim,20,1,M=nil)
#std1 = Student.new(park,21,2,F=nil)
#std2 = Student.new(choi,22,3,M=nil)
#std3 = Student.new(lee,24,2,gender=nil)
#std4 = Student.new(kang,25,4,gender=nil)
